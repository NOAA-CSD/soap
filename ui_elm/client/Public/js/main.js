...
var _user$project$Crd$init = {
	...
	data: _elm_lang$core$Array$fromList(
		{
			ctor: '::',
			_0: _user$project$Crd$CrdsCell(0)(0)(0)(0)(0)(0)(0)(0)(0)(
				{
					ctor: '::',
					_0: {
						ctor: '::',
...
var _user$project$GcrdTypes$toggleFilterAuto = function (f) {
	return _elm_lang$core$Native_Utils.update(
		f,
		{auto: !f.auto});
};
...
var _user$project$GcrdTypes$Filter = F4(
	function (a, b, c, d) {
		return {period: a, length: b, auto: c, pos: d};
	});
var _user$project$GcrdTypes$decodeFilter = A5(
	_elm_lang$core$Json_Decode$map4,
	_user$project$GcrdTypes$Filter,
	A2(_elm_lang$core$Json_Decode$field, 'period', _elm_lang$core$Json_Decode$int),
...
var _user$project$GcrdTypes$defaultCvtData = {
	...
	devIds: {ctor: '[]'},
	filter: A4(_user$project$GcrdTypes$Filter, 360, 30, true, 0),
	fan: false,
	fan_voltage: 0
};
...
var _user$project$Pas$toggleSpeakerCycle = function (spk) {
	return _elm_lang$core$Native_Utils.update(
		spk,
		{auto: !spk.auto});
};
var _user$project$Pas$setLengthSpk = F2(
	function (length, spk) {
		return _elm_lang$core$Native_Utils.update(
			spk,
			{length: length});
	});
var _user$project$Pas$setPeriodSpk = F2(
	function (period, spk) {
		return _elm_lang$core$Native_Utils.update(
			spk,
			{period: period});
			...
			case 'UpdateSpkLength':
				var new_model = A2(
					...
					A2(
						_user$project$Pas$asSpeakerIn,
						model.cvt,
						A2(_user$project$Pas$setLengthSpk, _p1._0, model.cvt.spk)));
				return new_model;
			default:
				var new_model = A2(
					_user$project$Pas$asCvtIn,
					...
					A2(
						_user$project$Pas$asSpeakerIn,
						model.cvt,
						A2(_user$project$Pas$setPeriodSpk, _p1._0, model.cvt.spk)));
				return new_model;
		}
	});
...
var _user$project$Pas$PasCvt = F9(
	function (a, b, c, d, e, f, g, h, i) {
		return {spk: a, b: b, m: c, fmod_0: d, fmod_1: e, heater_0: f, heater_1: g, enable_0: h, enable_1: i};
	});
var _user$project$Pas$Speaker_ = F8(
	function (a, b, c, d, e, f, g, h) {
		return {period: a, length: b, auto: c, vscale: d, voffset: e, center: f, df: g, pos: h};
	});
...
var _user$project$Pas$defaultHeater = A2(
	...
	18);
var _user$project$Pas$UpdateSpkLength = function (a) {
	return {ctor: 'UpdateSpkLength', _0: a};
};
var _user$project$Pas$UpdateSpkPeriod = function (a) {
	return {ctor: 'UpdateSpkPeriod', _0: a};
};
...
var _user$project$Pas$defaultSpk = A8(_user$project$Pas$Speaker_, '360', '30', true, '1', '0.5', '1350', '100', _user$project$Pas$Speaker);
var _user$project$Pas$defaultCvt = A9(
	_user$project$Pas$PasCvt,
	_user$project$Pas$defaultSpk,
	{
		ctor: '::',
		_0: 0,
		_1: {
	...
	1350,
	1350,
	_user$project$Pas$defaultHeater,
	_user$project$Pas$defaultHeater,
	false,
	false);
var _user$project$Pas$Laser = {ctor: 'Laser'};
var _user$project$Pas$toggleSpeakerPosition = function (spk) {
	var drive = _elm_lang$core$Native_Utils.eq(spk.pos, _user$project$Pas$Speaker) ? _user$project$Pas$Laser : _user$project$Pas$Speaker;
	return _elm_lang$core$Native_Utils.update(
		spk,
		{pos: drive});
};
...
var _user$project$Pas$decodeSpeaker = A9(
	_elm_lang$core$Json_Decode$map8,
	_user$project$Pas$Speaker_,
	A2(_elm_lang$core$Json_Decode$field, 'period', _user$project$Pas$intString),
	A2(_elm_lang$core$Json_Decode$field, 'length', _user$project$Pas$intString),
	A2(_elm_lang$core$Json_Decode$field, 'auto', _elm_lang$core$Json_Decode$bool),
	...
	A2(_elm_lang$core$Json_Decode$field, 'pos', _user$project$Pas$decodeDrive));
...
var _user$project$Main$UpdateSpkParams = {ctor: 'UpdateSpkParams'};
...
var _user$project$Main$ToggleSpeakerAuto = {ctor: 'ToggleSpeakerAuto'};
var _user$project$Main$ToggleSpeaker = {ctor: 'ToggleSpeaker'};
...
var _user$project$Main$toggleSpk = F2(
	function (model, val) {
		return A2(
			_elm_lang$http$Http$send,
			_user$project$Main$HandleGeneric,
			_elm_lang$http$Http$getString(
				A2(
					...
					A2(
						...
						A2(_elm_lang$core$Basics_ops['++'], val, '&cell=0')))));
	});
var _user$project$Main$updateSpkParams = function (model) {
	var period = model.pas.cvt.spk.period;
	var length = model.pas.cvt.spk.length;
	var auto = model.pas.cvt.spk.auto ? '1' : '0';
	return A2(
		_elm_lang$http$Http$send,
		_user$project$Main$HandleGeneric,
		_elm_lang$http$Http$getString(
					...
					A2(
						...
						A2(
							...
							A2(
								_elm_lang$core$Basics_ops['++'],
								length,
								A2(_elm_lang$core$Basics_ops['++'], '&period=', period))))))));
};
		...
		_1: {
				...
				model.mdl,
				{
					...
					_1: {
						...
						_1: {
							...
							_1: {
								ctor: '::',
								_0: _debois$elm_mdl$Material_Options$onClick(_user$project$Main$StopServer),
								_1: {
									ctor: '::',
			...
			_1: {
				...
				_0: A5(
					...
					model.mdl,
					{
						...
						_1: {
							...
							_1: {
								...
								_1: {
									ctor: '::',
									_0: _debois$elm_mdl$Material_Options$onClick(_user$project$Main$SyncTime),
									_1: {
										ctor: '::',
										_0: A2(_debois$elm_mdl$Material_Options$css, 'margin-top', '10px'),
										_1: {
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text('Sync Time'),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
																...
																_1: {
																	...
																	_1: {
																		...
																		_0: A5(
																				...
																				_1: {
																					...
																					_1: {
																						...
																						_1: {
																							...
																							_1: {
																								ctor: '::',
																								_0: _debois$elm_mdl$Material_Options$onClick(_user$project$Main$UpdateCrdScaling),
																								_1: {ctor: '[]'}
																							}
																						}
																					}
																			...
																			{
																				ctor: '::',
																				_0: _elm_lang$html$Html$text('Autoscale 1x'),
																				_1: {ctor: '[]'}
																			}),
																		_1: {ctor: '[]'}
																	}
								...
								model.mdl,
								{
									...
									_1: {
										...
										_1: {
											...
											_1: {
												ctor: '::',
												_0: _debois$elm_mdl$Material_Options$onClick(_user$project$Main$ClearMessages),
												_1: {
													ctor: '::',
													_0: A2(_debois$elm_mdl$Material_Options$css, 'margin-top', '10px'),
													_1: {ctor: '[]'}
...
var _user$project$Main$update = F2(
	function (msg, model) {
		...
		switch (_p27.ctor) {
				...
				var new_model = A2(
					...
					A2(
						...
						A2(
							_user$project$Pas$asSpeakerIn,
							model.pas.cvt,
							_user$project$Pas$toggleSpeakerPosition(model.pas.cvt.spk))));
				var val = _elm_lang$core$Native_Utils.eq(new_model.pas.cvt.spk.pos, _user$project$Pas$Speaker) ? '1' : '0';
				return {
					ctor: '_Tuple2',
					_0: new_model,
					_1: A2(_user$project$Main$toggleSpk, new_model, val)
				};
			case 'ToggleSpeakerAuto':
				var new_model = A2(
					_user$project$Main$asPasIn,
					model,
					A2(
						...
						A2(
							_user$project$Pas$asSpeakerIn,
							model.pas.cvt,
							_user$project$Pas$toggleSpeakerCycle(model.pas.cvt.spk))));
				return {
					ctor: '_Tuple2',
					_0: new_model,
					_1: _user$project$Main$updateSpkParams(new_model)
				};
			case 'UpdateSpkParams':
				return {
					ctor: '_Tuple2',
					_0: model,
					_1: _user$project$Main$updateSpkParams(model)
				};
			case 'UpdateMod0':
				var f_ = A2(
					_elm_lang$core$Result$withDefault,
			...
			case 'SendModulation':
				var _p31 = _p27._0;
				var freq = _elm_lang$core$Native_Utils.eq(_p31, '1') ? model.pas.cvt.fmod_1 : model.pas.cvt.fmod_0;
				...
				return {
					ctor: '_Tuple2',
					_0: model,
					_1: A3(_user$project$Main$setCellFrequency, model, _p31, f)
				};
				...
				switch (_p32.ctor) {
					...
					case 'Pas0Heater':
						...
						var new_sp = A2(
							_elm_lang$core$Result$withDefault,
							old_sp,
							_elm_lang$core$String$toFloat(_p33));
						var new_model = A2(
							_user$project$Main$asPasIn,
							model,
							A2(
			...
			case 'TogglePasLaserPower':
				var _p35 = _p27._0;
				var c = _elm_lang$core$Basics$toString(_p35);
				var new_model = A2(
					_user$project$Main$asPasIn,
					model,
					A2(
						_user$project$Pas$asCvtIn,
						model.pas,
						A2(_user$project$Pas$toggleLaserPower, _p35, model.pas.cvt)));
				var cmd = function () {
					var _p34 = _p35;
					switch (_p34) {
						case 0:
			...
			case 'UpdateDevSP':
				...
				var dev = A2(
					...
					A2(_elm_lang$core$Dict$get, _p36, model.alicats.cvt));
				...
				var new_model = A2(
					...
					A2(
						...
						model.alicats,
						A3(_elm_lang$core$Dict$insert, _p36, new_dev, model.alicats.cvt)));
				return {ctor: '_Tuple2', _0: new_model, _1: _elm_lang$core$Platform_Cmd$none};
			case 'SendDevSP':
				var _p37 = _p27._0;
				var dev = A2(
					_elm_lang$core$Maybe$withDefault,
					_user$project$Devices_Device$defaultDevice,
					A2(_elm_lang$core$Dict$get, _p37, model.alicats.cvt));
				return {
					ctor: '_Tuple2',
					_0: model,
					_1: A3(_user$project$Main$sendDevSp, _p37, dev, model)
				};
			case 'UpdateTime':
				return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
			case 'SyncTime':
			...
			case 'TogglePasPlot':
				...
				var d = A4(
					...
					_elm_lang$core$Maybe$withDefault,
					false,
					A2(_elm_community$list_extra$List_Extra$getAt, _p38, model.pasPlotData));
				var newModel = _elm_lang$core$Native_Utils.update(
					model,
					{
						pasPlotData: A3(_elm_community$list_extra$List_Extra$setAt, _p38, !d, model.pasPlotData)
					});
			...
			default:
				...
				var d = A2(
					_elm_lang$core$Maybe$withDefault,
					false,
					A2(_elm_community$list_extra$List_Extra$getAt, _p41, model.crdPlotData));
				var newModel = _elm_lang$core$Native_Utils.update(
					model,
					{
						crdPlotData: A3(_elm_community$list_extra$List_Extra$setAt, _p41, !d, model.crdPlotData)
					});
				return {ctor: '_Tuple2', _0: newModel, _1: _elm_lang$core$Platform_Cmd$none};
		}
	});
							...
							_1: {
								...
								_0: A5(
									...
									model.mdl,
									{
										...
										_1: {
											ctor: '::',
											_0: _debois$elm_mdl$Material_Toggles$value(model.pas.cvt.enable_0),
											_1: {
												ctor: '::',
												_0: _debois$elm_mdl$Material_Options$onToggle(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html$text('Power 0'),
										_1: {ctor: '[]'}
									}),
								_1: {
									ctor: '::',
									...
									_1: {
										...
										_0: A5(
											...
											model.mdl,
											{
												...
												_1: {
													ctor: '::',
													_0: _debois$elm_mdl$Material_Toggles$value(model.pas.cvt.enable_1),
													_1: {
														ctor: '::',
														_0: _debois$elm_mdl$Material_Options$onToggle(
											...
											{
												ctor: '::',
												_0: _elm_lang$html$Html$text('Power 1'),
												_1: {ctor: '[]'}
											}),
										_1: {
											ctor: '::',
									...
									_0: A5(
										...
										model.mdl,
										{
											...
											_1: {
												ctor: '::',
												_0: _debois$elm_mdl$Material_Toggles$value(
													_elm_lang$core$Native_Utils.eq(model.pas.cvt.spk.pos, _user$project$Pas$Speaker)),
												_1: {
													ctor: '::',
													_0: _debois$elm_mdl$Material_Options$onToggle(_user$project$Main$ToggleSpeaker),
													_1: {ctor: '[]'}
												}
											}
										},
									...
									_1: {
										...
										_0: A5(
											...
											model.mdl,
											{
												...
												_1: {
													ctor: '::',
													_0: _debois$elm_mdl$Material_Toggles$value(model.pas.cvt.spk.auto),
													_1: {
														ctor: '::',
														_0: _debois$elm_mdl$Material_Options$onToggle(_user$project$Main$ToggleSpeakerAuto),
														_1: {ctor: '[]'}
													}
												}
											},
												...
												model.mdl,
												{
													...
													_1: {
														...
														_1: {
															...
															_1: {
																ctor: '::',
																_0: _debois$elm_mdl$Material_Textfield$value(model.pas.cvt.spk.period),
																_1: {
																	ctor: '::',
																	_0: _debois$elm_mdl$Material_Options$onInput(
																		function (_p42) {
																			return _user$project$Main$Pas(
																				_user$project$Pas$UpdateSpkPeriod(_p42));
																		}),
																	_1: {
																		ctor: '::',
																		_0: _debois$elm_mdl$Material_Options$onBlur(_user$project$Main$UpdateSpkParams),
																		_1: {
																			ctor: '::',
																			_0: _debois$elm_mdl$Material_Textfield$label('Period (s)'),
																			_1: {ctor: '[]'}
																		}
																	}
																}
													...
													model.mdl,
													{
														...
														_1: {
															...
															_1: {
																...
																_1: {
																	ctor: '::',
																	_0: _debois$elm_mdl$Material_Textfield$value(model.pas.cvt.spk.length),
																	_1: {
																		ctor: '::',
																		_0: _debois$elm_mdl$Material_Options$onInput(
																			function (_p43) {
																				return _user$project$Main$Pas(
																					_user$project$Pas$UpdateSpkLength(_p43));
																			}),
																		_1: {
																			ctor: '::',
																			_0: _debois$elm_mdl$Material_Options$onBlur(_user$project$Main$UpdateSpkParams),
																			_1: {
																				ctor: '::',
																				_0: _debois$elm_mdl$Material_Textfield$label('Length (s)'),
																				_1: {ctor: '[]'}
																			}
																		}
																	}
																	...
																	_1: {
																		...
																		_1: {
																			...
																			_0: _debois$elm_mdl$Material_Options$onInput(
																				function (_p44) {
																					return _user$project$Main$Pas(
																						_user$project$Pas$UpdateSpkFcenter(_p44));
																				}),
																			_1: {
																				ctor: '::',
																		...
																		_1: {
																			...
																			_1: {
																				...
																				_0: _debois$elm_mdl$Material_Options$onInput(
																					function (_p45) {
																						return _user$project$Main$Pas(
																							_user$project$Pas$UpdateSpkDf(_p45));
																					}),
																				_1: {
																					ctor: '::',
																					_0: _debois$elm_mdl$Material_Options$onBlur(_user$project$Main$UpdateChirp),
																			...
																			_1: {
																				...
																				_1: {
																					...
																					_0: _debois$elm_mdl$Material_Options$onInput(
																						function (_p46) {
																							return _user$project$Main$Pas(
																								_user$project$Pas$UpdateSpkVscale(_p46));
																						}),
																					_1: {
																						ctor: '::',
																				...
																				_1: {
																					...
																					_1: {
																						...
																						_0: _debois$elm_mdl$Material_Options$onInput(
																							function (_p47) {
																								return _user$project$Main$Pas(
																									_user$project$Pas$UpdateSpkVoffset(_p47));
																							}),
																						_1: {
																							ctor: '::',
																							_0: _debois$elm_mdl$Material_Options$onBlur(_user$project$Main$SendSpkVoltage),
																					...
																					_1: {
																						...
																						_1: {
																							...
																							_1: {
																								...
																								_1: {
																									ctor: '::',
																									_0: _debois$elm_mdl$Material_Options$onClick(_user$project$Main$UpdatePasScaling),
																									_1: {ctor: '[]'}
																								}
																							}
																						}
