				...
				},
				{
					...
					_1: {
						...
						_0: A5(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text('Reset Sequence'),
								_1: {ctor: '[]'}
							}),
						_1: {ctor: '[]'}
					}
								...
								_1: {
									...
									_0: A5(
										...
										model.mdl,
										{
											...
											_1: {
												ctor: '::',
												_0: _debois$elm_mdl$Material_Toggles$value(model.pas.cvt.speaker_0),
												_1: {
													ctor: '::',
													_0: _debois$elm_mdl$Material_Options$onToggle(
									...
									_1: {
										...
										_0: A5(
											...
											model.mdl,
											{
												...
												_1: {
													ctor: '::',
													_0: _debois$elm_mdl$Material_Toggles$value(model.pas.cvt.speaker_1),
													_1: {
														ctor: '::',
														_0: _debois$elm_mdl$Material_Options$onToggle(
